...
public class HeapPage implements Page {
    ...
    private Deque<TransactionId> dirtyTransactions;
    ...
    public HeapPage(HeapPageId id, byte[] data) throws IOException {
        ...
        dirtyTransactions = new LinkedList<>();
...
//        throw new UnsupportedOperationException("implement this");
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        int no = recordId.getTupleNumber();
    ...
    public void markDirty(boolean dirty, TransactionId tid) {
        ...
        // not necessary for lab1
        if (dirty) {
            dirtyTransactions.offerLast(tid);
        } else {
    ...
    public TransactionId isDirty() {
        // some code goes here
        // Not necessary for lab1
        return dirtyTransactions.peekLast();
    }
    ...
    public int getNumEmptySlots() {
        ...
        for (int i = 0; i < header.length - 1; i++) {
            c += 8 - Integer.bitCount(header[i] & 0xFF);
        }

        byte last = header[header.length - 1];
        int bound = numSlots % 8;
        if (bound == 0) {
            bound = 8;
        }
